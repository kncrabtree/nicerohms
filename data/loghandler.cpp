...
LogHandler::LogHandler(QObject *parent) :
    QObject(parent)
{
    qRegisterMetaType<NicerOhms::LogMessageCode>("NicerOhms::MessageCode");
...
void LogHandler::logMessage(const QString text, const NicerOhms::LogMessageCode type)
{
	QDateTime time;
...
void LogHandler::writeToFile(const QString text, const NicerOhms::LogMessageCode type, const QString timeStamp)
{
