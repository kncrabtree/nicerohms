...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationDomain(QString("bjm.scs.illinois.edu"));
    QApplication::setOrganizationName(QString("McCall Research Group"));
    ...
    qRegisterMetaType<FreqCombData>("FreqCombData");
